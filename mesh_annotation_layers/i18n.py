...
ZH_CN = {
    ...
    "{type} · Active: {name}": "{type} · 当前：{name}",
    "Add Selected to {name}": "添加选中到「{name}」",
    "New Layer from Selected": "用选中元素新建标签",
    "Add Selected to Another Layer": "添加选中到其他标签",
    "Add Loop to {name}": "添加循环到「{name}」",
    "New Layer from Loop": "用循环新建标签",
    "Add Loop to Another Layer": "添加循环到其他标签",
